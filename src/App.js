...
function App() {
  ...
  useEffect(()=>{
    ...
    axios.get("https://api.github.com/users/Buushe").then((res)=>{
      console.log(res.data);
      setProfile(res.data);
    }) .catch((error)=>{
      console.log(error);
    });
    axios.get("https://api.github.com/users/Buushe/followers").then((res)=>{
      console.log(res.data);
      setFollowers(res.data);
    }).catch((error)=>{
      console.log(error);
    });
    axios.get("https://api.github.com/users/Buushe/following").then((res)=>{
      console.log(res.data);
